        ...
        function n() {
          ...
          return p(
            null == v
              ...
              : t === r
              ? [[Math.max(o[0] - n, v), i], [Math.min(o[0] + n, c), f]]
              : [[v, Math.max(o[1] - n, i)], [c, Math.min(o[1] + n, f)]],
          )
        }
        var i,
          c,
          ...
          function r() {
            ...
            A < h &&
              ...
              (W[0][0] === h &&
                ...
                W[1][0] === A &&
                W[1][1] === L) ||
                ((G.selection = [[h, g], [A, L]]), c.call(B), et.brush())
          }
          function i() {
          ...
          (n.extent = function(t) {
            return arguments.length
              ? ((R =
                  'function' == typeof t
                    ? t
                    : e.i(g.a)([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])),
                n)
              : R
          }),
          (n.filter = function(t) {
    ...
    function(t, n, e) {
      ...
      function u() {
        ...
        return (
          ...
          t
            .extentMajor([[-180, -90 + c.o], [180, 90 - c.o]])
            .extentMinor([[-180, -80 - c.o], [180, 80 + c.o]])
        )
      }
      function a() {
        return u()()
          ...
          if (null === this._x1)
            ...
            if (Math.abs(l * c - f * s) > 1e-6 && i) {
              var d = e - a,
                ...
                y = Math.sqrt(h),
                _ =
                  i * Math.tan((u - Math.acos((v + h - b) / (2 * g * y))) / 2),
                m = _ / y,
                x = _ / g
              Math.abs(m - 1) > 1e-6 &&
      ...
      function r() {
        ...
        return (
          (n.invertExtent = function(t) {
            ...
            return n < 0
              ? [NaN, NaN]
              : [n > 0 ? c[n - 1] : a[0], n < c.length ? c[n] : a[a.length - 1]]
          }),
          (n.domain = function(n) {
          ...
          (t.extent = function(n) {
            return arguments.length
              ? ((o =
                ...
                t)
              : o && [[o[0][0], o[0][1]], [o[1][0], o[1][1]]]
          }),
          (t.size = function(n) {
            return arguments.length
              ? ((o = null == n ? null : [[0, 0], [+n[0], +n[1]]]), t)
            ...
            if (E && ((E = clearTimeout(E)), !u.touch1))
              return (
                ...
                void (
                  (i = e
                    .i(h.i)(this)
                    .on('dblclick.zoom')) && i.apply(this, arguments)
                )
              )
            t &&
          ...
          (t.extent = function(n) {
            return arguments.length
              ? ((z =
                  'function' == typeof n
                    ? n
                    : e.i(p.a)([[+n[0][0], +n[0][1]], [+n[1][0], +n[1][1]]])),
                t)
              : z
          }),
